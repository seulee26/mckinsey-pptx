...
def build(output_path: str = "output/demo_korean.pptx") -> str:
    ...
    b.add(
        ...
        x_max=200, y_max=350,
        bubbles=[
            {"label": "CATL",      "x": 88,  "y": 260, "size": 4,   "group": "blue_dark",  "label_pos": "left"},
            {"label": "BYD",       "x": 82,  "y": 220, "size": 2.6, "group": "blue_dark",  "label_pos": "left"},
            {"label": "LGES",      "x": 105, "y": 295, "size": 2.4, "group": "blue_light", "label_pos": "top"},
            {"label": "SK On",     "x": 110, "y": 285, "size": 1.4, "group": "blue_light", "label_pos": "right"},
            {"label": "삼성SDI",   "x": 120, "y": 320, "size": 1.2, "group": "blue_light", "label_pos": "right"},
            {"label": "Panasonic", "x": 125, "y": 305, "size": 1.6, "group": "mid_blue",   "label_pos": "right"},
            {"label": "CALB",      "x": 95,  "y": 235, "size": 0.8, "group": "blue_dark",  "label_pos": "bottom"},
            {"label": "EVE",       "x": 98,  "y": 210, "size": 0.6, "group": "blue_dark",  "label_pos": "bottom"},
        ],
